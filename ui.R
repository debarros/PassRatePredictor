      ...
      mainPanel(
        tabsetPanel(
          ...
          tabPanel(title = "Diagram",
                   tags$img(src = "diagram.jpg")
          ),
          tabPanel(title = "Output",
                   h1(textOutput("response"))
          ),
          tabPanel(title = "Sample Data",
                   downloadLink('Sample1', 'Download Sample Old Predictor Scores'),tags$br(),
                   downloadLink('Sample2', 'Download Sample New Predictor Scores'),tags$br(),
                   downloadLink('Sample3', 'Download Sample Regents Scores')
          )
        )
      )
    )
